...
import fetch_students_for_course_saga from './reducers/fetch_students_for_course_saga';
import fetch_tutors_for_course_saga   from './reducers/fetch_tutors_for_course_saga';
...
sagaMiddleware.run(fetch_students_for_course_saga);
sagaMiddleware.run(fetch_tutors_for_course_saga);
